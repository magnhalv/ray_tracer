...
pub fn gen_vector(x: f64, y: f64, z: f64) -> Vector {
    Vector {
        x,
        y,
        z,
...
pub fn gen_point(x: f64, y: f64, z: f64) -> Point {
...
fn sub_point_from_point_gives_vector() {
    let p1 = gen_point(10.0_f64, 9.0_f64, 8.0_f64);
    let p2 = gen_point(1.0_f64, 2.0_f64, 3.0_f64);
    let result = p1 - p2;
...
fn sub_vector_from_point_gives_point() {
    let point = gen_point(10.0_f64, 9.0_f64, 8.0_f64);
    let vector = gen_vector(1.0_f64, 2.0_f64, 3.0_f64);
    let result = point - vector;
    let expected = gen_point(9.0_f64, 7.0_f64, 5.0_f64);
    assert_eq!(result, expected);
}
...
fn add_vector_to_point_gives_point() {
    ...
    let vector = gen_vector(1.0_f64, 2.0_f64, 3.0_f64);
    let result = point + vector;
    let expected = gen_point(11.0_f64, 11.0_f64, 11.0_f64);
    assert_eq!(result, expected);
}
...
fn add_vector_to_vector_gives_vector() {
    let v1 = gen_vector(10.0_f64, 9.0_f64, 8.0_f64);
    let v2 = gen_vector(1.0_f64, 2.0_f64, 4.0_f64);
    let result = v1 + v2;
    let expected = gen_vector(11.0_f64, 11.0_f64, 12.0_f64);
    assert_eq!(result, expected);
}
...
fn negating_point() {
    let point = gen_point(10.0_f64, -9.0_f64, 8.0_f64);
    let result = -point;
    let mut expected = gen_point(-10.0_f64, 9.0_f64, -8.0_f64);
...
fn multiply_point_by_scalar() {
    ...
    let mut expected = gen_point(20.0_f64, -18.0_f64, 16.0_f64);
    expected.w = 2.0_f64;
...
fn normalize_vector() {
    ...
    assert_eq!(
        v1.normalize(),
        gen_vector(1.0_f64, 0.0_f64, 0.0_f64)
    );
...
fn cross_product_vector() {
    ...
    assert_eq!(
        v2.cross(v1),
        gen_vector(0.0_f64, 1.0_f64, 0.0_f64)
    );
    assert_eq!(
        v1.cross(v2),
        gen_vector(0.0_f64, -1.0_f64, 0.0_f64)
