...
mod tests {
    use crate::matrix::{
        cofactor3, cofactor4, determinant2, determinant3, determinant4, inverse4, minor3,
        submatrix3, submatrix4, transpose4, Matrix2, Matrix3, Matrix4,
    };
    ...
    #[test]
    fn init_2x2_matrix() {
        let matrix = Matrix2::new(1_f32, 2_f32, 3_f32, 4_f32);
    ...
    #[test]
    fn matrix_equals() {
        let matrix1 = Matrix2::new(1_f32, 2_f32, 3_f32, 4_f32);

        let matrix2 = Matrix2::new(1_f32, 2_f32, 3_f32, 4_f32);
    ...
    fn matrix_multiplication() {
        let matrix1 = Matrix4::new(
            1_f32, 2_f32, 3_f32, 4_f32, 5_f32, 6_f32, 7_f32, 8_f32, 9_f32, 8_f32, 7_f32, 6_f32,
            5_f32, 4_f32, 3_f32, 2_f32,
        );
        let matrix2 = Matrix4::new(
            -2_f32, 1_f32, 2_f32, 3_f32, 3_f32, 2_f32, 1_f32, -1_f32, 4_f32, 3_f32, 6_f32, 5_f32,
            1_f32, 2_f32, 7_f32, 8_f32,
        );
        let expected = Matrix4::new(
            20_f32, 22_f32, 50_f32, 48_f32, 44_f32, 54_f32, 114_f32, 108_f32, 40_f32, 58_f32,
            110_f32, 102_f32, 16_f32, 26_f32, 46_f32, 42_f32,
        );
    ...
    fn matrix_transpose() {
        let matrix = Matrix4::new(
            0_f32, 9_f32, 1_f32, 0_f32, 9_f32, 8_f32, 0_f32, 8_f32, 1_f32, 8_f32, 5_f32, 3_f32,
            0_f32, 0_f32, 5_f32, 8_f32,
        );
        let expected = Matrix4::new(
            0_f32, 9_f32, 1_f32, 0_f32, 9_f32, 8_f32, 8_f32, 0_f32, 1_f32, 0_f32, 5_f32, 5_f32,
    ...
    fn matrix_determinant() {
        let matrix = Matrix2::new(1_f32, 5_f32, -3_f32, 2_f32);
    ...
    fn matrix_submatrix() {
        ...
        let expected1 = Matrix2::new(4_f32, 6_f32, 7_f32, 9_f32);
        ...
        let expected2 = Matrix3::new(
            5_f32, 6_f32, 7_f32, 9_f32, 10_f32, 11_f32, 13_f32, 14_f32, 15_f32,
        );
    ...
    fn matrix3_minor() {
        let m = Matrix3::new(
            3_f32, 5_f32, 0_f32, 2_f32, -1_f32, -7_f32, 6_f32, -1_f32, 5_f32,
        );
    ...
    fn matrix3_determinant() {
        let m = Matrix3::new(
            1_f32, 2_f32, 6_f32, -5_f32, 8_f32, -4_f32, 2_f32, 6_f32, 4_f32,
        );
    ...
    fn matrix4_determinant() {
        let m = Matrix4::new(
            -2_f32, -8_f32, 3_f32, 5_f32, -3_f32, 1_f32, 7_f32, 3_f32, 1_f32, 2_f32, -9_f32, 6_f32,
    ...
    fn matrix4_is_invertibile() {
        let m = Matrix4::new(
            6_f32, 4_f32, 4_f32, 4_f32, 5_f32, 5_f32, 7_f32, 6_f32, 4_f32, -9_f32, 3_f32, -7_f32,
            9_f32, 1_f32, 7_f32, -6_f32,
        );
        assert_eq!(true, is_invertible(&m));

        let m = Matrix4::new(
            -4_f32, 2_f32, -2_f32, -3_f32, 9_f32, 6_f32, 2_f32, 6_f32, 0_f32, -5_f32, 1_f32,
            -5_f32, 0_f32, 0_f32, 0_f32, 0_f32,
        );
    ...
    fn matrix4_invert() {
        let m = Matrix4::new(
            -5_f32, 2_f32, 6_f32, -8_f32, 1_f32, -5_f32, 1_f32, 8_f32, 7_f32, 7_f32, -6_f32,
            -7_f32, 1_f32, -3_f32, 7_f32, 4_f32,
        );
        ...
        let a = Matrix4::new(
            3_f32, -9_f32, 7_f32, 3_f32, 3_f32, -8_f32, 2_f32, -9_f32, -4_f32, 4_f32, 4_f32, 1_f32,
            -6_f32, 5_f32, -1_f32, 1_f32,
        );

        let b = Matrix4::new(
            8_f32, 2_f32, 2_f32, 2_f32, 3_f32, -1_f32, 7_f32, 0_f32, 7_f32, 0_f32, 5_f32, 4_f32,
