...
pub fn translation(x: f32, y: f32, z: f32) -> Matrix4 {
    Matrix4::new(
        1_f32, 0_f32, 0_f32, x, 0_f32, 1_f32, 0_f32, y, 0_f32, 0_f32, 1_f32, z, 0_f32, 0_f32,
        0_f32, 1_f32,
    )
}
...
pub fn scaling(x: f32, y: f32, z: f32) -> Matrix4 {
    Matrix4::new(
        x, 0_f32, 0_f32, 0_f32, 0_f32, y, 0_f32, 0_f32, 0_f32, 0_f32, z, 0_f32, 0_f32, 0_f32,
        0_f32, 1_f32,
    )
}
...
pub fn shearing(
    ...
    Matrix4::new(
        1_f32, x_to_y, x_to_z, 0_f32, y_to_x, 1_f32, y_to_z, 0_f32, z_to_x, z_to_y, 1_f32, 0_f32,
        0_f32, 0_f32, 0_f32, 1_f32,
    )
}
...
pub fn view_transform(from: &Tuple, to: &Tuple, up: &Tuple) -> Matrix4 {
    ...
    let orientation = Matrix4::new(
        left.x, left.y, left.z, 0_f32, true_up.x, true_up.y, true_up.z, 0_f32, -forward.x,
        -forward.y, -forward.z, 0_f32, 0_f32, 0_f32, 0_f32, 1_f32,
    );
...
mod tests {
    ...
    fn rotation_y_axis() {
        ...
        assert_eq!(
            &half_quarter * &point,
            Tuple::point(2_f32.sqrt() / 2_f32, 0_f32, 2_f32.sqrt() / 2_f32)
        );
    ...
    fn rotation_z_axis() {
        ...
        assert_eq!(
            &half_quarter * &point,
            Tuple::point(-2_f32.sqrt() / 2_f32, 2_f32.sqrt() / 2_f32, 0_f32)
        );
        assert_eq!(&full_quarter * &point, Tuple::point(-1_f32, 0_f32, 0_f32));
    }
    #[test]
