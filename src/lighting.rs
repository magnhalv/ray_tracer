...
pub fn lighting(material: &Material, obj: &dyn Shape, light: &PointLight, point: &Tuple, eye_dir: &Tuple, &surface_normal: &Tuple, in_shadow: bool) -> Color {    
...
fn lighting_with_the_eye_between_the_light_and_the_surface() {
    ...
    let result = lighting(&material, &Sphere::new(0), &light, &position, &eye_vector, &normal, false);    
...
fn lighting_with_the_surface_in_shadow() {
    ...
    let result = lighting(&material, &Sphere::new(0), &light, &position, &eye_vector, &normal, in_shadow);    
    assert_eq!(result, Color::new(0.1_f32, 0.1_f32, 0.1_f32));
}